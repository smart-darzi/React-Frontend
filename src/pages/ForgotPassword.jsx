...
import { Scissors, Mail, Lock, ArrowRight, ShieldAlert, ArrowLeft, KeyRound, CheckCircle2 } from 'lucide-react';
      ...
      >
        ...
        <div className="hidden lg:block relative z-10 space-y-[clamp(0.75rem,3vh,2rem)]">
          ...
          <p className="text-white/60 text-[clamp(0.8rem,2.2vh,1.125rem)] font-medium leading-relaxed max-w-sm">
            {step === 'password'
              ? "Enter your new password below — you're almost done."
              : "Enter your account email and set a new password, right here."}
          </p>
        </div>
      ...
      <div className="flex-1 flex items-start lg:items-center justify-center p-[clamp(1rem,4vh,2rem)] px-[clamp(1.25rem,5vw,2rem)] bg-slate-50">
        ...
        >
          {step !== 'done' && (
            ...
            >
              <ArrowLeft size={16} /> {step === 'password' ? 'Back' : 'Back to Login'}
            </Link>
          )}
          ...
          <AnimatePresence mode="wait">
            {step === 'done' ? (
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 font-medium text-lg">
                    Account: <span className="font-black text-slate-700">{email}</span>
                  </p>
                </div>
              ...
              >
                <div className="space-y-2">
                  <h2 className="text-4xl font-black text-slate-800 tracking-tighter">Reset your password</h2>
                  <p className="text-slate-500 font-medium text-lg">Enter your account email to continue</p>
                </div>
